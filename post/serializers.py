...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        # PUT requestda ham imageni soramay faqat captionni update qilish uchun

    def get_post_likes_count(self, obj):
        return obj.likes.count()
    # obj.likes.count() - ya'ni masalan obj = post bolganda post objectlari ichidan related_name orqali likes list olinadi va uni count qilinadi
...
class CommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PostComment
        fields = [
            'id', 'author', 'comment', 'parent', 'created_time', 'replies', 'me_liked', 'likes_count',
        ]
